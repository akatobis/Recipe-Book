    ...
    public partial class _001addtableRecipe : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_recipe_favourite", x => x.RecipeFavouriteId);
                    table.ForeignKey(
                        name: "FK_recipe_favourite_recipe_RecipeId",
                        column: x => x.RecipeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_recipe_like", x => x.RecipeLikeId);
                    table.ForeignKey(
                        name: "FK_recipe_like_recipe_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "recipe",
                        principalColumn: "RecipeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_recipe_favourite_RecipeId",
                table: "recipe_favourite",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_recipe_like_RecipeId",
                table: "recipe_like",
                column: "RecipeId");
